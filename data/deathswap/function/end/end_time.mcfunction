execute if score end deathswap.timer matches ..201 run scoreboard players add end deathswap.timer 1
...
execute if score end deathswap.timer matches 200 if score language deathswap.setting matches 1 run title @a subtitle {"text": "§dMade by vipvincent"}
...
# execute if score end deathswap.timer matches 200 if score language deathswap.setting matches 2 run title @a subtitle {"text": "§d製作：早安豆江 vipvincent"}
