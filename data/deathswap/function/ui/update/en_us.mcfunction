...
#swap_time
execute if score swap_time_setting deathswap.setting matches 300 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 300s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 330 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 330s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 360 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 360s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 390 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 390s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 420 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 420s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 450 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 450s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 480 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 480s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 510 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 510s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 540 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 540s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 570 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 570s","italic":false}',lore=['"§7Time interval for player position swaps"']]
execute if score swap_time_setting deathswap.setting matches 600 run item replace entity @a[tag=admin,gamemode=!creative] inventory.9 with ender_eye[custom_data={ui:1b},custom_name='{"text":"§bSwap Time: 600s","italic":false}',lore=['"§7Time interval for player position swaps"']]
