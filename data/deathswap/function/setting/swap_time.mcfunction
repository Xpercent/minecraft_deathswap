...
#中文
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 300 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b300秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 330 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b330秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 360 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b360秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 390 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b390秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 420 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b420秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 450 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b450秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 480 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b480秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 510 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b510秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 540 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b540秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 570 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b570秒"}]
execute if score language deathswap.setting matches 2 if score swap_time_setting deathswap.setting matches 600 run tellraw @a [{"text": "§6死亡交換§7§l｜§r"},{"text": "§f傳送時間已變更為§b600秒"}]
